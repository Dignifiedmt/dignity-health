    ...
    const aboutItems = [
        {
            ...
            title: "Game da Mu",
            description:
                "Manufarmu ita ce samar da bayanai masu inganci da tallafi ga iyaye da masu kulawa don inganta lafiyar mata da yara a cikin al’ummarmu.",
        ...
        },
        {
            ...
            title: "Manufarmu",
            description:
                "Muna fatan al’umma inda kowane yaro zai sami damar rayuwa cikin lafiya da farin ciki, kuma kowace uwa ta sami tallafin da ake bukata don kula da kanta da yaranta.",
        ...
        },
        {
            ...
            title: "Hangenmu",
            description:
                "Ƙungiyarmu ta ƙwararru tana haɗa kai da iyaye, masu kulawa, da ƙungiyoyi don samar da bayanai masu aminci da ayyuka don haɓaka lafiyar mata da yara.",
